# Config Baseline: release preparation
...
The original validation files describe the extraction revisions. Fresh preparation
receipts are recorded by the companion repository; they must name the tested commits.
