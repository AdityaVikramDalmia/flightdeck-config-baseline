---
name: config-baseline-maintainer
description: Maintain deprecated Config Baseline's commands, documentation, examples, and release material as a public reference implementation. Use for changes in this repository.
---

# Maintain Config Baseline
